...
| C06 / §9.4 | Every write is signed by the connected wallet and paid in MON; Privy handles login/TEE wallet access but never replaces chain authorization or pays gas | Two-user wallet-paid acceptance P2; insufficient-balance, rejection, wrong-chain and retry tests |
